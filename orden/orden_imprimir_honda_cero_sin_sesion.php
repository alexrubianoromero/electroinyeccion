...
$sql_empresa = "select * from $tabla10 where id_empresa = 50 ";
...
$sql_mecanico = "select nombre from $tabla21 where idcliente = '".$datos[0]['mecanico']."'   ";
...
<table width="80%" border="0">
  ...
  <?php  $subtotal =  muestre_items($_REQUEST['idorden'],$tabla15,$conexion,'50'); 
