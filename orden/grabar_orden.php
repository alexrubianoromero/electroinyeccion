...
$sql_grabar_orden = "insert into $tabla14 (orden,placa,sigla,fecha,observaciones,radio,antena,repuesto,herramienta,otros,
	iva,id_empresa,estado,kilometraje,mecanico,tipo_orden,kilometraje_cambio,horas) 
values (
'".$_POST['orden_numero']."',
'".$_POST['placa']."',
'".$_POST['clave']."',
...
///////////////////////
///////////////////////  lo del correo 
$sql_empresa = "select razon_social as nombre, email_empresa,direccion  from $tabla10  ";
