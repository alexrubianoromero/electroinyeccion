...
echo '</pre>';
*/
$sql_grabar_salida = "insert into $tabla23 (fecha_recibo,dequienoaquin,porconceptode,lasumade,observaciones,tipo_recibo,numero_recibo,id_empresa) 
values (
'".$_POST['fecha']."'
,'".$_POST['dequienoaquin']."' 
,'".$_POST['porconceptode']."'
...
echo '<br>';
echo  '<h2><a href="recibo_imprimir.php?numero='.$_POST['numero_recibo'].'">VISTA IMPRESION DE RECIBO</a></h2>';
