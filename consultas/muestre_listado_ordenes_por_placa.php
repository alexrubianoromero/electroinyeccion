...
$sql_listado_ordenes = "select id,fecha,orden,estado,kilometraje,kilometraje_cambio,anulado from $tabla14 where placa = '".$_REQUEST['placa123']."' and id_empresa = '".$_SESSION['id_empresa']."' ";
