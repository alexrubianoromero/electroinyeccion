...
<body>
<? include("empresa.php");
$sql_ruta_imagen = "select ruta_imagen,nombre,tipo_taller,opcion_caja from $tabla10 where id_empresa = '".$_SESSION['id_empresa']."'  ";  
...
<Div id="contenidos">
	    ...
	    <li><a href="orden/index.php" class="menu">ORDENES DE TRABAJO</a></li>
		  ...
		  <?php
		  if ($datos_empresa['opcion_caja'] > 0)
		  {
		   echo '<li><a href="caja/index.php" class="menu">CAJA</a></li>';
		   }
		   ?>
		  ...
		  <li><a href="inventario_codigos/index.php" class="menu">CODIGOS DE INVENTARIO</a></li>
			...
			<li><a href="informes/index.php" class="menu">INFORMES</a></li>
