...
<?php
echo '<table border= "1">';
	echo '<td><h3>No FACTURA<h3></td><td><h3>PAGO/DEBE<h3></td><td><h3>TIPO FACTURA<h3></td><td><h3>ANULADO<h3></td><td><h3>Fecha</h3></td><td><h3>Placa/Identidad</h3></td><td><h3>Correo</h3></td><td><h3>Impresion</h3></td>'; 
		while($ordenes = mysql_fetch_array($consulta_ordenes))
			{ 
				...
				echo  '<td><h3>';
				echo '<a href="generar_correo_items.php?id_factura='.$ordenes['3'].'"  target = "_blank" >Correo</a>';
				echo '</h3></td>'; 
				echo  '<td><h3>';
