...
<td><strong>FORMA DE PAGO </strong> </td><td colspan = "6" ><input name="formapagotexto"   id = "formapagotexto"  type="text" size ="100" class = "fila_llenar"  > </td>
</tr>
<tr>
          <?php  
...
?>	        </td>
        ...
        <td width="10%"><?php 
			 ...
			 <td width="20%" > <?php echo '
                 <label>
                 <input type="checkbox" name="forma_pago"  id =  "forma_pago"  value = "1">
                 </label>';  ?> </td>
</tr>
</table>
			   ...
			   $("#codigopan").keyup(function(e){
				...
				/////////////////////////////////	
					...
					$("#actualizar_orden").click(function(){
							...
							data += '&subtotal_factura=' + $("#subtotal_factura").val();
							...
							data += '&formapagotexto=' + $("#formapagotexto").val();
